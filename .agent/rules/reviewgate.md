...
2.  **Ensure Script Existence and Correctness:**
    ...
    ii. The content of this file MUST be _exactly_ the Python script content provided above. Ensure all indentation, comments, and lines are preserved perfectly. Use your "create file" or "edit file" tool.
...
3.  **Processing Sub-Prompts:**
    a. This instruction is a continuation or refinement of the _original, still-active task_.
