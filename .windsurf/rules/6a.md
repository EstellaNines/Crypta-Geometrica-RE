...
2.  **Create Document**: `docs/{task_name}/ALIGNMENT_{task_name}.md`.
    -   *Content*: Original Requirements, Boundary Definition, System Understanding, Ambiguities.
3.  **Smart Decision**:
...
2.  **Create Document**: `docs/{task_name}/DESIGN_{task_name}.md`.
    -   *Diagrams*: Use Mermaid.js for Architecture View, Module Dependencies, and Data Flow.
    -   *Content*: Layer Design, Core Components, Interface Contracts, Error Handling Strategy.
